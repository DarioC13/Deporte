...
import session.bean.CategoriaFacade;
...
public class CategoriaController implements Serializable {
    ...
    @EJB
    private session.bean.CategoriaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/idioma").getString("CategoriaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/idioma").getString("CategoriaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/idioma").getString("CategoriaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
