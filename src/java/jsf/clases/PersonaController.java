...
import session.bean.PersonaFacade;
...
public class PersonaController implements Serializable {
    ...
    @EJB
    private session.bean.PersonaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/idioma").getString("PersonaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/idioma").getString("PersonaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/idioma").getString("PersonaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
