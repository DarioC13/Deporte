...
import session.bean.InscripcionFacade;
...
public class InscripcionController implements Serializable {
    ...
    @EJB
    private session.bean.InscripcionFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/idioma").getString("InscripcionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/idioma").getString("InscripcionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/idioma").getString("InscripcionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
